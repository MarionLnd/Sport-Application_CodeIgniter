...
--
-- Host: localhost
-- Generation Time: Jun 15, 2017 at 02:11 PM
...
(0, 'Lundi', 'Marion', 'toto@free.fr'),
(2, 'Pearson', 'Leila', 'neque.Nullam.nisl@uteratSed.edu'),
(3, 'Ball', 'Jeremy', 'est.Nunc.laoreet@lorem.net'),
(5, 'Gould', 'Patricia', 'Sed.eu.eros@eget.org'),
(6, 'Griffith', 'Moana', 'metus@inceptos.ca'),
(7, 'Terry', 'Garrett', 'nulla.magna.malesuada@nonummy.org'),
(8, 'Blackburn', 'Scarlett', 'tempus.non.lacinia@dignissimtempor.ca'),
(9, 'Odonnell', 'Angelica', 'nibh.Quisque@molestieorci.net'),
(10, 'Trevino', 'Naida', 'adipiscing@conubianostra.net'),
(12, 'Berry', 'Mallory', 'dolor@blanditmattis.ca'),
(13, 'Rivera', 'Blossom', 'erat@tempusmauris.org'),
(14, 'Frazier', 'April', 'non@Donecegestas.net'),
(15, 'Brown', 'Camden', 'ipsum.nunc.id@nulla.com'),
(16, 'Noble', 'Lisandra', 'tincidunt.nunc.ac@fermentumconvallisligula.org'),
(17, 'David', 'Brian', 'ac@Integeraliquamadipiscing.org'),
(18, 'Fulton', 'Ira', 'ullamcorper@Naminterdum.co.uk'),
(19, 'Walls', 'Samantha', 'semper.pretium@Donec.co.uk'),
(21, 'Hudson', 'Quinn', 'Donec.porttitor@tellusAeneanegestas.org'),
(22, 'Richmond', 'Matthew', 'Lorem.ipsum.dolor@tempor.org'),
(23, 'Benjamin', 'Timothy', 'mi.eleifend.egestas@augue.com'),
(24, 'Green', 'Sean', 'sed.pede@nequeet.com'),
(25, 'Macias', 'Joan', 'elementum.lorem.ut@orciUt.net'),
(26, 'Gardner', 'Evangeline', 'ac.ipsum@viverraDonectempus.ca'),
(27, 'Holman', 'Chester', 'tincidunt.aliquam.arcu@luctusaliquetodio.org'),
(28, 'Lloyd', 'Gay', 'Lorem@vitae.co.uk'),
(29, 'Flores', 'Wallace', 'turpis.vitae.purus@Sedidrisus.ca'),
(30, 'Goodwin', 'Abbot', 'sit@Aliquamnecenim.ca'),
(31, 'Robles', 'Dakota', 'sed.tortor.Integer@aliquetodioEtiam.org'),
(32, 'Madden', 'Amelia', 'semper@placeratorci.co.uk'),
(33, 'Flynn', 'Nicholas', 'blandit.enim.consequat@ridiculus.ca'),
(34, 'Hutchinson', 'Shaeleigh', 'massa.Mauris@dignissimlacus.org'),
(35, 'Spence', 'Zenia', 'justo.Proin@mauris.edu'),
(36, 'Hunt', 'Denise', 'lectus.quis@Integer.org'),
(37, 'Mccarty', 'Grant', 'tortor.Integer@dictumeleifendnunc.org'),
(38, 'Simon', 'George', 'justo.Proin@enimMauris.com'),
(39, 'Nelson', 'Veda', 'nec.orci@massarutrummagna.co.uk'),
(40, 'Ramsey', 'Pascale', 'feugiat.non.lobortis@Fuscealiquam.net'),
(41, 'Massey', 'Castor', 'lacus@euelitNulla.org'),
(42, 'Mathis', 'Steel', 'eu@quisturpis.ca'),
(43, 'Cooley', 'Colleen', 'posuere.cubilia.Curae@laoreet.ca'),
(44, 'Vinson', 'Lucius', 'Etiam.vestibulum.massa@Aenean.ca'),
(45, 'Yang', 'Ginger', 'amet@erat.ca'),
(46, 'Cooper', 'Hyacinth', 'Morbi.quis@quam.co.uk'),
(47, 'Whitfield', 'Ann', 'at.libero@vitae.co.uk'),
(48, 'Camacho', 'Marah', 'et.magnis@telluseuaugue.org'),
(49, 'White', 'Kameko', 'nascetur.ridiculus@tristique.com'),
(50, 'Cruz', 'Gabriel', 'enim.diam.vel@fermentumrisus.edu'),
(51, 'Patton', 'Germaine', 'vitae.aliquam.eros@molestietellusAenean.ca'),
(52, 'Guerra', 'Madeson', 'sagittis.lobortis.mauris@quisdiam.ca'),
(53, 'Holcomb', 'Skyler', 'nonummy.ultricies@placeratCrasdictum.org'),
(54, 'Hester', 'Orla', 'vulputate.eu.odio@cursusvestibulumMauris.ca'),
(55, 'Dodson', 'Rina', 'porttitor@faucibus.edu'),
(56, 'Carter', 'Leandra', 'molestie.tortor@adipiscing.ca'),
(57, 'Greene', 'Haley', 'odio.semper.cursus@vitaedolorDonec.net'),
(58, 'Morrison', 'Thaddeus', 'Suspendisse.commodo.tincidunt@nequenonquam.org'),
(59, 'Hardin', 'Giacomo', 'Vivamus.nibh.dolor@Aenean.org'),
(60, 'Goodman', 'Cheryl', 'sit@ultricesVivamus.co.uk'),
(61, 'Manning', 'Magee', 'eget.laoreet@ProinultricesDuis.edu'),
(62, 'Lane', 'Charles', 'mauris.elit@id.net'),
(63, 'Ballard', 'Wynne', 'enim.Curabitur@blandit.net'),
(64, 'Good', 'Colin', 'eu@ipsumdolor.org'),
(65, 'Weber', 'Ignatius', 'Donec.porttitor@est.com'),
(66, 'Hoover', 'Curran', 'scelerisque@primis.co.uk'),
(67, 'Henry', 'Alexandra', 'Donec@ornare.com'),
(68, 'Barnett', 'Hadassah', 'Cras@laciniaatiaculis.net'),
(69, 'Schultz', 'Olympia', 'penatibus@liberoduinec.co.uk'),
(70, 'Baird', 'TaShya', 'iaculis.nec@bibendumullamcorper.com'),
(71, 'Marquez', 'David', 'elit.pede@inhendrerit.edu'),
(72, 'Elliott', 'Colt', 'Maecenas.mi.felis@diamdictum.org'),
(73, 'Murray', 'Upton', 'auctor@pretium.ca'),
(74, 'Henry', 'Shelley', 'ligula@enim.org'),
(75, 'Keith', 'James', 'libero.Proin@Nullam.co.uk'),
(76, 'Andrews', 'Ali', 'rhoncus.Donec@Nuncsedorci.net'),
(77, 'Dunlap', 'Geraldine', 'ac.turpis.egestas@Nuncpulvinararcu.edu'),
(78, 'Duran', 'Harriet', 'odio.a.purus@arcuimperdietullamcorper.org'),
(79, 'Huff', 'Victor', 'Sed.malesuada.augue@pedeultricesa.org'),
(80, 'Hahn', 'Lillith', 'est.tempor.bibendum@nuncacmattis.edu'),
(81, 'Holman', 'Blythe', 'nisl@ligulaNullam.co.uk'),
(82, 'Frank', 'Ora', 'ornare@lacus.com'),
(83, 'Dunlap', 'Gisela', 'pede.sagittis@ametmetus.co.uk'),
(84, 'Bailey', 'Porter', 'Quisque.imperdiet.erat@tinciduntnuncac.net'),
(85, 'Vargas', 'Eden', 'Quisque.fringilla@ultricessit.co.uk'),
(86, 'Mcintyre', 'Cruz', 'amet.consectetuer@eu.com'),
(87, 'Hoffman', 'Kelly', 'Etiam.gravida@tortordictumeu.edu'),
(88, 'Ratliff', 'Charde', 'augue@anteVivamusnon.co.uk'),
(89, 'Morse', 'Simone', 'Cum.sociis.natoque@fringillapurus.edu'),
(90, 'Gallegos', 'Hayden', 'lacus@maurissit.ca'),
(91, 'Conrad', 'Raven', 'id.sapien@amet.co.uk'),
(92, 'Mathews', 'Palmer', 'Suspendisse.sagittis.Nullam@nascetur.org'),
(93, 'Taylor', 'Carl', 'egestas.Aliquam@necmollis.net'),
(94, 'Richmond', 'Richard', 'egestas@arcu.ca'),
(95, 'Beard', 'Cheryl', 'fermentum.arcu@malesuada.ca'),
(96, 'Tyson', 'Phelan', 'ridiculus.mus.Donec@tellus.com'),
(97, 'Schneider', 'Zenia', 'nibh.enim.gravida@etmagnisdis.edu'),
(98, 'Woods', 'Ali', 'ac.urna@aliquetsemut.com'),
(99, 'Cole', 'Blair', 'lorem.lorem.luctus@sitamet.edu'),
(100, 'Mejia', 'Scarlett', 'ac@nonummyut.com');
...
CREATE TABLE `Equipe` (
  ...
  `MdpInscrit` varchar(50) NOT NULL,
  `Logo` text NOT NULL,
  `Sport` varchar(30) NOT NULL,
  `Ville` varchar(50) NOT NULL,
  `Mixite` varchar(10) NOT NULL,
...
INSERT INTO `Equipe` (`NomEquipe`, `MdpInscrit`, `Logo`, `Sport`, `Ville`, `Mixite`, `Description`, `idEquipe`) VALUES
('Yo', '$2y$10$rdnJvkWDkFuFIZpIqU6QAO/p7vzWU1qf6CHq5Y6KBaD', 'Feu', 'Athlétisme', 'Paris', 'Hommes', '', 1);
...
INSERT INTO `Utilisateur` (`Login`, `Nom`, `Prenom`, `Password`, `Mail`, `Avatar`, `id`) VALUES
('aaa', 'aaa', 'aaa', '7e240de74fb1ed08fa08d38063f6a6a91462a815', 'aaa@f.fr', '', 5),
('coucou', 'coucou', 'coucou', 'f36b4825e5db2cf7dd2d2593b3f5c24c0311d8b2', 'coucou@p.fr', '', 4),
('judi', 'Koffi', 'Judicael', '2f00b4b80e6f4d7e881d6dd151703cd03e56b80d', 'judi@eskobar.co', '', 3),
('Linjh', 'Jolly', 'Mathilde', '00d70c561892a94980befd12a400e26aeb4b8599', 'Mathiilde@gmail.com', '', 1),
('Maye', 'Lnd', 'Marion', 'b70f7d0e2acef2e0fa1c6f117e3c11e0d7082232', 'm@f.fr', '', 2);
...
--
ALTER TABLE `Membre`
  ADD CONSTRAINT `log` FOREIGN KEY (`Login`) REFERENCES `Utilisateur` (`Login`) ON DELETE NO ACTION ON UPDATE NO ACTION;
